...
#define BIGRAMS_COUNT 10
#define MAX_BIGRAMS 10000

#define IMPOSSIBLE_COMBINATIONS_LIST_LENGTH 46
#define WORDLIST_LENGTH 112

#define DEFAULT_MIN_VALID_WORDS 0.85

#define VOWELS_COUNT 6

extern const wchar_t *FREQUENT_BIGRAMS_RU[];
extern const double BIGRAMS_FREQUENCIES_RU[];
